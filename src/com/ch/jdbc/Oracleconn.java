...
public class Oracleconn {
	...
	public Connection getConn() throws ClassNotFoundException, SQLException, IOException{
		...
		prop.load(in);
		String url=prop.getProperty("orclurl");
		String username=prop.getProperty("orclname");
		String password=prop.getProperty("orclpassword");
		String driver=prop.getProperty("orcldriver");
